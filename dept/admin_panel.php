...
<div class="container mt-5">
    ...
    <div class="row justify-content-center">
        <div class="col-12 col-md-4 mb-3">
            <button class="btn btn-primary w-100" onclick="location.href='Admin_board.php'">
                <i class="fas fa-cogs"></i> (Infomatrix) Admin
            </button>
        </div>
        <div class="col-12 col-md-4 mb-3">
            <button class="btn btn-success w-100" onclick="location.href=' /GNOME/Dashboard_admin.php'">
                <i class="fas fa-users"></i> (GNOME) Admin
            </button>
        </div>
        <div class="col-12 col-md-4 mb-3">
            <button class="btn btn-danger w-100" onclick="location.href=' /idcc/admin_board.php'">

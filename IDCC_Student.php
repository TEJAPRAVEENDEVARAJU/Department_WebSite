...
if (!isset($_SESSION['username'])) {
    header("Location: IDCC_student_login.php");
    exit();
}
...
<body>
    ...
    <main class="container mt-4">
        <?php if (!isset($student_id)): ?>
            <section class="card p-4">
                ...
                <form method="POST" action="IDCC_student.php">
                    <div class="mb-3">
        ...
        <?php else: ?>
            <section class="card p-4">
                ...
                <form method="POST" action="IDCC_submit_answers.php" id="examForm">
                    <!-- Student ID -->
    ...
    <script>
        window.onload = function() {
            ...
            window.location.href = "IDCC_student_login.php";
        };
    </script>
<?php endif; ?>
</body>
